...
#ani.replay()
saveHTML(ani.replay(), img.name = "practicing", htmlfile = "analysis/animations.html")
```
...
oopts = ani.options(interval = 0.05,loop=TRUE)
#ani.replay()
saveHTML(ani.replay(), img.name = "rotations1", htmlfile = "analysis/animations.html")
```
...
# ani.replay()
saveHTML(ani.replay(), img.name = "rotation2", htmlfile = "analysis/animations.html")
```
